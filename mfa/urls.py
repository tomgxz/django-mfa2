...
# /auth paths are for when the user is logging in
# /recheck parths are for when the user is already logged in and is performing secured actions
# as such, auth functions do not need breadcrumbs
